...
use App\Http\Controllers\Api\V1\SuperAdmin\PendingRegistrationController;
...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware(['auth:sanctum', 'tenant.bind_authenticated', 'ensure.super_admin'])
        ...
        ->group(function () {
            ...
            Route::post('/registration-requests/{registrationRequest}/approve', [PendingRegistrationController::class, 'approve']);
            Route::post('/registration-requests/{registrationRequest}/reject', [PendingRegistrationController::class, 'reject']);
        });
});
